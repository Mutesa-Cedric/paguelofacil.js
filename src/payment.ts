...
import { PaymentInformation, CardInformation, ReverseInformation, CaptureInformation } from './types/Information';
import { AuthBody, ReverseBody, RecurrentBody, CaptureBody } from './types/RequestBody';
